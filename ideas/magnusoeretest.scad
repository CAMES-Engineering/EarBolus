...
module earbox(x_box,y_box,z_box,CPRnumber,z_move_small_cylinder){
...
module cubeEar(){
    ...
    translate([x_move_blue_cylinder,y_move_blue_cylinder,z_move_blue_cylinder])color("blue")cylinder((z_move_small_cylinder+5)-z_box,2,2);
}
cubeEar();
